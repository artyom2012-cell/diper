...
async def handle_verify(callback: types.CallbackQuery):
    ...
    await bot.send_message(
        ...
        "4. ✍️ Введите @PriceGaftNFT_bot и предоставьте разрешения",
